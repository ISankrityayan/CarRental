...
namespace CarRentalAssignment.Tests;
[TestFixture]
public class Tests
{
    ...
    //    {
    //        connectionString = "Server=localhost,1433;;Database=CarRentalDb;User ID=sa;Password=reallyStrongPwd123;Trusted_Connection=True;Integrated Security=False;"
